# 📚 BookVerse - Modern Responsive Bookstore

![BookVerse Banner](https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?auto=format&fit=crop&w=1200&q=80)

Welcome to **BookVerse**, a highly interactive, modern, and fully responsive Book Store website created using pure HTML5, CSS3, and JavaScript. This project was built to deliver a premium, seamless user experience without the reliance on external frontend frameworks.
...
```text
ReadNest_Book_Store/
├── index.html        # Home Page (Hero slider, Categories, Featured Books, Stats)
...
Since this project relies on vanilla web technologies, there are no dependencies to install or build steps required!

1. **Download** or clone the repository to your local machine.
2. Open the `ReadNest_Book_Store` folder.
3. Simply **double-click** on `index.html` to launch the website in your default web browser.
4. *(Optional)* For the best development experience, open the folder in an editor like VS Code and use the **Live Server** extension to run the project.
